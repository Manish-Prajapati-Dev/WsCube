    ...
    return (
        <View key={item.id} style={Styles.componentStyle} >
            <TouchableOpacity activeOpacity={0.5} onPress={() => handleFullView(item)} >
                <Image source={{ uri: item.item.images[0] }} style={{ width: width * .3, height: height * .2, resizeMode: 'cover', borderRadius: 10, borderColor: '#f1f2f6', borderWidth: 0.2 }} />
            </TouchableOpacity>
            ...
            <View style={Styles.heading}>
                ...
                <TouchableOpacity activeOpacity={0.5} onPress={clickSeeAll} >
                    <View style={Styles.seeAll} >
                        ...
                        <Icon name={"keyboard-arrow-right"} size={15} color="#e7e7e7" />
                    </View>
                </TouchableOpacity>
            </View>
            <FlatList
